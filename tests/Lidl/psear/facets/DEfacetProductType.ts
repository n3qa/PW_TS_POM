...
export default class DEfacetProductType extends LidlBase{
  ...
  public async validate_SK_SearchResultsPageHTMTitle(){
    try {
      ...
      public async debugTestCase1() {
        ...
        await this.page.locator('#Produkttyp').getByRole('button', { name: 'Alles anzeigen' }).click();
        await this.page.getByRole('button', { name: 'Weniger anzeigen' }).click();
      }

      public async debugTestCase2() {
        await this.page.goto('https://www.lidl.de/q/search?q=*');
        await this.page.getByRole('button', { name: 'Filtern nach Produkttyp' }).click();
        await this.page.getByRole('button', { name: 'Filtern nach Produkttyp' }).click();
      }

      public async debugTestCase3() {
        await this.page.goto('https://www.lidl.de/q/search?q=*');
        await this.page.locator('label').filter({ hasText: 'Leuchtmittel' }).click();
      }

      public async debugTestCase4() {
        await this.page.goto('https://www.lidl.de/q/search?q=*');
        await this.page.locator('label').filter({ hasText: 'Leuchtmittel' }).click();
        await this.page.locator('label').filter({ hasText: 'Deckenleuchten' }).click();
        await this.page.locator('label').filter({ hasText: 'Dekoleuchten' }).click();
      }

      public async debugTestCase5() {
        await this.page.goto('https://www.lidl.de/q/search?q=*');
        await this.page.locator('label').filter({ hasText: 'Zubehör' }).click();
        await this.page.locator('label').filter({ hasText: 'Akku' }).click();
      ...
      public async debugTestCase6() {
        ...
        await this.page.locator('label').filter({ hasText: 'Deckenleuchten' }).click();
        await this.page.locator('label').filter({ hasText: 'Dekoleuchten' }).click();
        await this.page.getByRole('link', { name: 'Leuchtmittel' }).click();
        await this.page.getByRole('link', { name: 'Deckenleuchten' }).click();
        await this.page.getByRole('link', { name: 'Dekoleuchten' }).click();
      }
    }
