...
test("DE - PROD - 1 - SEARCH-VIEW | SERP | Cookies | OneTrust | Accept all | "+
    ...
    async ({lidlStoreFront }) => {
         ...
         await lidlStoreFront.DEsrp().validate_facet_category_state_expanded();
         await lidlStoreFront.DEsrp().validate_facet_category_canBe_Collapsed();
         ...
         await lidlStoreFront.DEsrp().validate_facet_price_state_expanded();
         await lidlStoreFront.DEsrp().validate_facet_price_canBe_Collapsed();
         ...
         await lidlStoreFront.DEsrp().validate_facet_brand_state_expanded();
         await lidlStoreFront.DEsrp().validate_facet_brand_canBe_Collapsed();
         ...
         await lidlStoreFront.DEsrp().validate_facet_color_state_expanded();
         await lidlStoreFront.DEsrp().validate_facet_color_canBe_Collapsed();
         ...
         await lidlStoreFront.DEsrp().validate_facet_size_state_expanded();
         await lidlStoreFront.DEsrp().validate_facet_size_canBe_Collapsed();
         ...
         await lidlStoreFront.DEsrp().validate_facet_ratings_state_expanded();
         await lidlStoreFront.DEsrp().validate_facet_ratings_canBe_Collapsed();

         //4.7. Validate load more grids button initial state (expanded) presented and can be clicked 
         console.log('Validate color facet initial state (expanded) presented and can be collapsed  ');
         await lidlStoreFront.DEsrp().validate_load_more_grids_btn_canBe_clicked();

         //4.7. Validate search results page sorting options are presented and can be activated 
         console.log('-> Validate color facet initial state (expanded) presented and can be collapsed  ');
         await lidlStoreFront.DEsrp().validate_load_more_grids_btn_canBe_clicked();

         await lidlStoreFront.DEsrp().takePageScreenShot('cookies/oneTrust/DE_PROD_1_SERP_Cookies_OneTrust_AcceptAll_CS');

    });

test("DE - PROD - 2 - SEARCH-VIEW | SERP | Cookies | OneTrust | Reject all | "+
    "Verify SERP is presented when a " +
    "valid search term is used with combination of " +
    ...
    async ({lidlStoreFront }) => {
         ...
         await lidlStoreFront.DECookies().clickOn_RejectAllCS_btn();
         ...
         await lidlStoreFront.DEsrp().takePageScreenShot('cookies/oneTrust/DE_PROD_2_SERP_Cookies_OneTrust_RejectAll_CS');

    });

test("DE - PROD - 3 - SEARCH-VIEW | SERP | Cookies | OneTrust | Preferences | "+
    "Verify SERP is presented when a " +
    "valid search term is used with combination of " +
    ...
    async ({lidlStoreFront }) => {
         ...
         await lidlStoreFront.DECookies().clickOn_AdvancedCS_btn();

         //STEP 3:
         // CLick on Accept all cookies oneTrust cookie settings button
         console.log("STEP 3: CLick on oneTrust preferences cookies settings button");
         await lidlStoreFront.DECookies().clickOn_Preferences_btn();
         ...
         await lidlStoreFront.DECookies().clickOn_SubmitAdvanceCS_btn();
         ...
         await lidlStoreFront.DEsrp().takePageScreenShot('cookies/oneTrust/DE_PROD_3_SERP_Cookies_OneTrust_Preferences_CS');

    });

test("DE - PROD - 4 - SEARCH-VIEW | SERP | Cookies | OneTrust | Statistics | "+
    "Verify SERP is presented when a " +
    "valid search term is used with combination of " +
    ...
    async ({lidlStoreFront }) => {
         ...
         // CLick on Accept all cookies oneTrust cookie settings button
         console.log("STEP 3: CLick on oneTrust preferences cookies settings button");
         await lidlStoreFront.DECookies().clickOn_Statistics_btn();
         ...
         await lidlStoreFront.DEsrp().takePageScreenShot('cookies/oneTrust/DE_PROD_4_SERP_Cookies_OneTrust_Statistics_CS');

    });

test("DE - PROD - 5 - SEARCH-VIEW | SERP | Cookies | OneTrust | Marketing | "+
    "Verify SERP is presented when a " +
    "valid search term is used with combination of " +
    "Statistics cookies settings",
    async ({lidlStoreFront }) => {
         ...
         // CLick on Accept all cookies oneTrust cookie settings button
         console.log("STEP 3: CLick on oneTrust preferences cookies settings button");
         await lidlStoreFront.DECookies().clickOn_Marketing_btn();
