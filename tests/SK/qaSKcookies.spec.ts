...
test("SK - QA - 3 - SEARCH-VIEW | SERP | Cookies | OneTrust | Preferences | "+
    "Verify SERP is presented when a " +
    "valid search term is used with combination of " +
...
test("SK - QA - 4 - SEARCH-VIEW | SERP | Cookies | OneTrust | Statistics | "+
    "Verify SERP is presented when a " +
    "valid search term is used with combination of " +
...
test("SK - QA - 5 - SEARCH-VIEW | SERP | Cookies | OneTrust | Marketing | "+
    "Verify SERP is presented when a " +
    "valid search term is used with combination of " +
    "Statistics cookies settings",
    async ({lidlStoreFront }) => {
